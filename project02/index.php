            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4 c-12 position-relative">
                        <img src="./assets/img/pizza.jpg" class="explore__img img-fluid" alt="...">
                        <span class="explore__img-title">Pizza</span>
                    </div>
                    <div class="col-4 c-12 position-relative">
                        <img src="./assets/img/burger.jpg" class="explore__img img-fluid" alt="...">
                        <span class="explore__img-title">Burger</span>
                    </div>
                    <div class="col-4 c-12 position-relative">
                        <img src="./assets/img/momo.jpg" class="explore__img img-fluid" alt="...">
                ...
                <div class="row">
                    ...
                    <div class="col-6 c-12">
                        <div class="menu__item card d-flex flex-row p-4">
                            <img class="menu__item-img" src="./assets/img/menu-momo.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
